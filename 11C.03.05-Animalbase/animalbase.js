...
function start( ) {
    ...
    document.querySelector("[data-filter='dog']").addEventListener("click", () => prepareAnimals(isDog));
    document.querySelector("[data-filter='*']").addEventListener("click", () => prepareAnimals(all));
